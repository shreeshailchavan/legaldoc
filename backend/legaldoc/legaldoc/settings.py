"""
Django settings for legaldoc project.
...
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')  # Store uploaded files in 'media/' folder

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/5.1/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = "django-insecure-v%)gjz#a_u=g!lsyamtl^n54^s)q9$)_@z4y(6y!pzcki4+lo6"
